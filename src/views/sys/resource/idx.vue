        ...
        <Content :style="{padding: '24px 0', minHeight: '280px', background: '#fff'}">
            <Layout>
                ...
                <Sider hide-trigger :style="{background: '#fff',padding:'24px 0 0 24px',borderRight:'1px solid #eee'}">
                    <ResourceTree ref="leftResourceTree" :showCheckbox="leftResource.showCheckbox" :multiple="leftResource.multiple" @select="selectTree"></ResourceTree>
                </Sider>
                <!--右侧-->
    ...
    export default {
        ...
        methods:{
            ...
            pageinit(){
                ...
                var endPage = this.page.toal==0?1:((this.page.total/this.page.pageSize)+(this.page.total%this.page.pageSize==0?0:1));
                if(endPage<this.page.pageNum){
                    this.page.pageNum=endPage;
                }
